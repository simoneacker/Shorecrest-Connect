...
/// Custom Eureka row used to select a location using map kit. Found code on the Eureka github page.
...
public class MapViewController : UIViewController, TypedRowControllerType, MKMapViewDelegate {
  ...
  lazy var pinView: UIImageView = { [unowned self] in
    ...
    v.image = UIImage(named: "map_pin_icon", in: Bundle(for: MapViewController.self), compatibleWith: nil)
  ...
  public override func viewDidLoad() {
    ...
    if let value = row.value {
      let region = MKCoordinateRegionMakeWithDistance(value.coordinate, 1000, 1000)
